namespace :ckeditor do
  ...
  task :create_nondigest_assets do
    ...
    for file in Dir['public/assets/ckeditor/contents-*.css', 'public/assets/ckeditor/skins/moono/*.png', 'public/assets/ckeditor/lang/*.js', 'public/assets/ckeditor/skins/moono/*.css']
