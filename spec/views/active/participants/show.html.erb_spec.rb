...
RSpec.describe "active/participants/show", type: :view do
  ...
  it "renders the participant's full name" do
    participant = Participant.new(
      ...
      first_contact: FirstContact.new(contact_at: now),
      first_appointment: FirstAppointment.new(appointment_at: now),
      second_contact: SecondContact.new(contact_at: now),
      third_contact: ThirdContact.new(contact_at: now),
      final_appointment: FinalAppointment.new(appointment_at: now)
    )
